...
class AppColors {
  ...
  static const Color card = Color(0xFFEDEDED); // light cards like "How are you feeling today?"
  static const Color primary = Color(0xFF9C27B0); // purple from logo
  static const Color primaryDark = Color(0xFF6A1B9A);
  static const Color accent = Color(0xFFE91E63); // pink/magenta
